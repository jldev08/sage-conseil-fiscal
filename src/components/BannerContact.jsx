...
export default function BannerContact() {
    return (
        <section className="bg-cover bg-no-repeat home-contactus-banner h-full">
            <div className="flex justify-center items-center h-full w-full flex-col p-4">
                <h4 className="text-4xl text-white text-center">Merci de votre intérêt pour Les Experts de Sage Conseil Fiscal Inc.</h4>
